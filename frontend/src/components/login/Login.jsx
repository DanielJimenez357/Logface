  ...
  <>
    ...
    <div className="bg-gris1 w-6/10 h-6/10 rounded-3xl flex flex-row shadow shadow-gris2">
      <div className="w-5/10 h-full">
        ...
        <div className="flex flex-col justify-start p-5 w-5/10 h-full items-center ">
          <p className="text-5xl w-full text-center mb-[15%]">Iniciar Sesion</p>
            { error && <motion.p initial={{ opacity: 0, y:20, filter: "blur(10px)"}} animate={{opacity: 1, y:0, filter: "none"}} exit={{ opacity: 0, y: 10}} className="rounded-lg bg-rojo2 text-center p-3 mb-[5%]">{error}</motion.p> }
